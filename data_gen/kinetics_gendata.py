...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='/home/data1/yanghao/SklAC/Shift-GCN-master/data/kinetics-skeleton_raw')
    parser.add_argument(
        '--out_folder', default='/home/data1/yanghao/SklAC/Shift-GCN-master/data/kinetics_without_mask')
